...
bindRange('#rainRange','#rainPct','#dockRain');bindRange('#trainRange','#trainPct','#dockTrain');bindRange('#hornRange','#hornPct','#dockHorn');bindRange('#musicRange','#musicPct','#dockMusic');bindRange('#volumeRange','#volumePct','#dockVolume');
$('#playBtn').onclick=()=>{playing=!playing;app.classList.toggle('paused',!playing);$('#playBtn').textContent=playing?'Ⅱ':'▶'};
